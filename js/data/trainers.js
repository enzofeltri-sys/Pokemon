...
PKMN.TRAINERS = {
  ...
  gym11_trainer: {
    name: "Fauconnier",
    team: [{ species: 84, level: 56 }],
    reward: 700,
    onWin: [{ setFlag: "beat_gym11_trainer", value: true }]
  },

  gym11_leader: {
    name: "Auréa",
    team: [{ species: 42, level: 58 }, { species: 142, level: 60 }],
    reward: 2600,
    onWin: [{ badge: "badge11" }, { setFlag: "beat_gym11", value: true }]
  },

  gym12_trainer: {
    name: "Karatéka",
    team: [{ species: 67, level: 58 }],
    reward: 750,
    onWin: [{ setFlag: "beat_gym12_trainer", value: true }]
  },

  gym12_leader: {
    name: "Roklan",
    team: [{ species: 57, level: 60 }, { species: 106, level: 62 }],
    reward: 2800,
    onWin: [{ badge: "badge12" }, { setFlag: "beat_gym12", value: true }]
  },

  gym13_trainer: {
    name: "Somnambule",
    team: [{ species: 96, level: 60 }],
    reward: 800,
    onWin: [{ setFlag: "beat_gym13_trainer", value: true }]
  },

  gym13_leader: {
    name: "Oniria",
    team: [{ species: 97, level: 62 }, { species: 122, level: 64 }],
    reward: 3000,
    onWin: [{ badge: "badge13" }, { setFlag: "beat_gym13", value: true }]
  },

  gym14_trainer: {
    name: "Ingénieur",
    team: [{ species: 81, level: 62 }],
    reward: 850,
    onWin: [{ setFlag: "beat_gym14_trainer", value: true }]
  },

  gym14_leader: {
    name: "Ferrus",
    team: [{ species: 82, level: 64 }, { species: 141, level: 66 }],
    reward: 3200,
    onWin: [{ badge: "badge14" }, { setFlag: "beat_gym14", value: true }]
  },

  gym15_trainer: {
    name: "Veilleuse",
    team: [{ species: 91, level: 64 }],
    reward: 900,
    onWin: [{ setFlag: "beat_gym15_trainer", value: true }]
  },

  gym15_leader: {
    name: "Séléna",
    team: [{ species: 131, level: 66 }, { species: 121, level: 68 }],
    reward: 3400,
